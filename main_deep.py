...
from deepClustering import deepGroupClustering,deepDiversityClustering
...
for file_path in datasets:
    ...
    print('\n---Deep Group---')
    if not os.path.exists('Synth Results\\Deep Group Communities'):
        os.makedirs('Synth Results\\Deep Group Communities')
        
    if not os.path.exists('Synth Results\Deep Group Communities\\'+datasetName):
        os.makedirs('Synth Results\\Deep Group Communities\\'+datasetName)
    ...
    if not os.path.exists('Synth Results\\Deep Diversity Communities'):
        os.makedirs('Synth Results\\Deep Diversity Communities')
        
    if not os.path.exists('Synth Results\Deep Diversity Communities\\'+datasetName):
        os.makedirs('Synth Results\\Deep Diversity Communities\\'+datasetName)
    ...
    if not os.path.exists('Synth Results\\Deep Fairness Communities'):
        os.makedirs('Synth Results\\Deep Fairness Communities')
        
    if not os.path.exists('Synth Results\Deep Fairness Communities\\'+datasetName):
        os.makedirs('Synth Results\\Deep Fairness Communities\\'+datasetName)
