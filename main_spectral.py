...
from spectralClustering import spectralGroupClustering, spectralDiversityClustering
...
for file_path in datasets:
    ...
    print('\n---Group Spectral---')
    if not os.path.exists('Synth Results\\Group Spectral Communities'):
        os.makedirs('Synth Results\\Group Spectral Communities')
        
    if not os.path.exists('Synth Results\\Group Spectral Communities\\'+datasetName):
        os.makedirs('Synth Results\\Group Spectral Communities\\'+datasetName)
        
        
    blue_communities = spectralGroupClustering(adjacency,graph_attributes,lamda=0.5)
    ...
    plotName = datasetName+'_Group Spectral'
    plotCommunities(graph, graph_attributes, blue_communities, datasetName, plotName,'Group Spectral Communities')
    ...
    community_df.to_csv(os.path.join('Synth Results\\Group Spectral Communities\\'+datasetName, datasetName + '_communities.csv'), index=False)
    ...
    print('\n---Diversity Spectral---')
    if not os.path.exists('Synth Results\\Diversity Spectral Communities'):
        os.makedirs('Synth Results\\Diversity Spectral Communities')
        
    if not os.path.exists('Synth Results\Diversity Spectral Communities\\'+datasetName):
        os.makedirs('Synth Results\\Diversity Spectral Communities\\'+datasetName)
        
        
    blue_communities = spectralDiversityClustering(adjacency,graph_attributes,lamda=0.5)
    ...
    plotName = datasetName+'_Diversity Spectral'
    plotCommunities(graph, graph_attributes, blue_communities, datasetName, plotName,'Diversity Spectral Communities')
    ...
    community_df.to_csv(os.path.join('Synth Results\\Diversity Spectral Communities\\'+datasetName, datasetName + '_communities.csv'), index=False)
